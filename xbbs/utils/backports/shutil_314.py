# This file is part of CPython, specifically, it is part of Git revision
# 8e2f4b448380b4c835442534d566618f06e32573 of CPython.  It is copied here to backport the
# copy_file_range-utilizing copyfile (and copy2).
#
# This file is *NOT UNDER THE SAME LICENSE AS THE REST OF XBBS*.  It is subject to the same term as
# CPython, and is unmodified compared to the aforementioned revision.
...
_USE_CP_SENDFILE = hasattr(os, "sendfile") and sys.platform.startswith(
    ("linux", "android", "sunos")
)
...
def _make_zipfile(
    base_name, base_dir, verbose=0, dry_run=0, logger=None, owner=None, group=None, root_dir=None
):
...
def __getattr__(name):
    if name == "ExecError":
        ...
        warnings._deprecated(
            "shutil.ExecError",
            f"{warnings._DEPRECATED_MSG}; it " "isn't raised by any shutil function.",
            remove=(3, 16),
        )
        return RuntimeError
